...
public class GenericSpecificationsBuilder<T> {
    ...
    public final GenericSpecificationsBuilder<T> with(String alias, final String key, final SearchOperation searchOperation, final List<Object> arguments) {
        return with(alias, key, searchOperation, false, arguments);
    }
    ...
    public final GenericSpecificationsBuilder<T> with(final String key, final SearchOperation searchOperation, final List<Object> arguments) {
        return with(null, key, searchOperation, false, arguments);
    }

    public final GenericSpecificationsBuilder<T> with(String alias, final String key, final SearchOperation searchOperation, final boolean isOrOperation, final List<Object> arguments) {
        params.add(new SearchCriteria(alias,key, searchOperation, isOrOperation, arguments));
        return this;
}
