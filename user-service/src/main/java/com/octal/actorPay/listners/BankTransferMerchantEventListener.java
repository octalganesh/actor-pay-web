 ...
 */
@Component
public class BankTransferMerchantEventListener implements ApplicationListener<BankTransferMerchantEvent> {
    ...
    @Override
    public void onApplicationEvent(BankTransferMerchantEvent event) {
        ...
        try {
            ...
            if(!TextUtils.isEmpty(user.getDeviceToken())){
